...
Project created for the purpose of learning Swift language. A game for iPad where the user need to guess the word based on clues and string fragments. 
...
2. Locate the file named **Swifty Words.xcodeproj** and click on it to open the Xcode IDE. 
